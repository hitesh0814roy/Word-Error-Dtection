...
OUTPUT_FILE = r"C:\Users\HITESH S ROY\OneDrive\Documents\Medical_Checker\Output\Detection_BioClinicalBERT_Test.xlsx"
...
def detect_incorrect_words(text):
    ...
    detection_confidence.The model shuld skip the words from which full stop in connected,
    and still they make sense"""
